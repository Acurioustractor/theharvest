...
const paths = [
  ...
  { title: "Lend a hand", body: "Garden jobs, work days and practical help. Come for ten minutes or two hours.", href: trackedPath("/get-involved?form=volunteer", "volunteer"), action: "Offer some help", icon: HandHeart, colour: "bg-[#4A6741] text-white" },
