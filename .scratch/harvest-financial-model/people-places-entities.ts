...
const PEOPLE: Person[] = [
  {
    name: "Dennis",
    role: "Was hospitality lead. Left when the 10-week trial ended 1 Sep 2026",
    monthlyCost: 0,
    costConfidence: "verified",
    costSource: "Ben, 7 Sep 2026",
    shares: { harvest: 1 },
    sharesConfidence: "verified",
    livesAt: null,
    note: "Kept as a row so the history reads. Pizza nights now run by Ben and Nic with Nic's dad (unpaid founder and family labour), then community-run sessions are tested. Nobody is paid to host.",
  },
  {
    name: "Nic's dad",
    role: "Pizza night crew with Ben and Nic",
    monthlyCost: 0,
    costConfidence: "verified",
    costSource: "Ben, 7 Sep 2026",
    shares: { harvest: 1 },
    sharesConfidence: "verified",
    livesAt: null,
    note: "Family labour. Unpaid, so a volunteer under WHS (a worker) and the insurance question in the broker call sheet applies to him too.",
  },
  {
    name: "Trina",
  ...
  {
    name: "Joey",
    role: "Community steward; beds, garden, build; also Goods work. Proposed on-site caretaker",
    monthlyCost: 3720,
    ...
    sharesConfidence: "assumption",
    livesAt: "harvest",
    note: "Ben, 7 Sep 2026: Joey may move in as caretaker and works across Goods and Harvest. Caretaker means: on site overnight, opens and closes the gate, first call for the site, hosts work days, second on the till at pizza. Split is a placeholder for Ben and Nic to set. Contractor today; live-in plus set duties looks like employment, ask Standard Ledger. If rent is reduced for caretaking, that is pay in kind.",
  },
  {
    name: "Susie",
...
const ENTITY_MAP: EntityRule[] = [
  ...
  {
    money: "Susie, Joey wages (Harvest share); any future paid host",
