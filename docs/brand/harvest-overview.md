# The Harvest overview

This is the plain-language overview for The Harvest.

Use it when someone needs to understand the place quickly before looking at the website, deck, photos, works pages, or comms plan.
...
Over time, The Harvest should also become a living collection place for Witta: photos, objects, timber stories, dairy memories, co-op records, local food knowledge, and the small stories that belong to the ridge.

## What it is not

The Harvest is not a polished venue brand.
...
The current works to keep clear:

- Garden Area: seedlings, beds, soil, shade and paths until July.
...
The website should stand at the gate.
...
Use fewer claims and more proof.

## Where photos and video fit

Every photo or video should be sorted by:

- Area: Garden, kitchen, art, events/community, whole site.
- Story thread: timber, dairy, co-op, garden, Witta history, launch, people.
- Page job: homepage, works page, Witta story, update note, social tile, deck, archive.
- Rights state: approved, needs consent, attribution needed, internal only.

The working flow is:

```text
capture -> source note -> room -> work/story -> page -> GHL publishes -> Notion records
```
...
Before publishing a line, ask:

- Is there a room in it?
- Is there a body, tool, plant, plate, material, or place in it?
- Does it stop before it over-explains itself?
